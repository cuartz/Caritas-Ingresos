...
<html>
    <head>
        ...
        <script type="text/javascript"> 
            ...
            var storeCBTIPODONANTE = Ext.create('Ext.data.SimpleStore',{
                autoLoad: true,
                fields: ['ID', 'NOMBRE'],
                data: listaFiltros
            });  
...
//                        {name: 'FECHA_COBRO'},
            ...
            var storeRep_MYS_RECIBOS_POR_TIPODONANTE_6 = Ext.create('Ext.data.JsonStore', {// create the Store Atenciones
                ...
                proxy: {
                    type: 'ajax',
                    url: 'reportesAC.do?method=report_Rep_MYS_RECIBOS_POR_TIPODONANTE', 
//                    url: 'reportesAC.do?method=report_TES_concentradocobranza', 
                    reader: {
                        type: 'json',
                        root: 'rows',
            ...
            //Inicia
            Ext.define('Reportes.Rep_MYS_RECIBOS_POR_TIPODONANTE_6', {
                extend: 'Ext.window.Window',
                id:'Rep_MYS_RECIBOS_POR_TIPODONANTE_6',
                name: 'Reportes.Rep_MYS_RECIBOS_POR_TIPODONANTE_6',
                alias:'widget.Rep_MYS_RECIBOS_POR_TIPODONANTE_6',                
                title: 'Reporte de Tesoreria Concentrado de Cobranza',
                width: 1150,                
                height: 600,
                border: false,
                buttonAlign: 'left',
                ...
                initComponent: function() {
                    Ext.apply(this, {
                        items: [
                            {
                                xtype: 'grid',
                                store: storeRep_MYS_RECIBOS_POR_TIPODONANTE_6,
                                id:'gridRep_MYS_RECIBOS_POR_TIPODONANTE_6a',
                                name: 'gridRep_MYS_RECIBOS_POR_TIPODONANTE_6',
                                columns: [
//                                    {
...
//                                    ,
                                    ...
                                    items: [
                                        {
                                            ...
                                            listeners: {
                                                select: function(field, value, option){
                                                    ...
                                                    storeRep_MYS_RECIBOS_POR_TIPODONANTE_6.load();
                                                }
                                            }
                                        }
                                        ,
                                        ...
                                        ,{xtype:'tbseparator'},
                                        {
                                            ...
                                            name: 'Tipo_Listado',
                                            id: 'Tipo_Donante',
                                            fieldLabel: 'Tipo Donante',
                                            labelWidth: 45,
                                            store: storeCBTIPODONANTE,
                                            anchor: '60%',
                                            editable: false,
                                            valueField: 'ID',
                                            allowBlank:false,
                                        ...
                                        ,Ext.create('Ext.Button', {
                                            ...
                                            iconCls:'icon-xlsx',
                                            handler: function() {
                                                window.open("ShowExcel?idOperationType=96&fechaini="+parametersAT.fechaini+ "&fechafin="+parametersAT.fechafin+"&usuario="+parametersAT.usuario);
                                            }
                                        }),
                                        {xtype:'tbseparator'},
                                        {
                                            ...
                                            handler: function()
                                            {
                                                var win=Ext.getCmp('Rep_MYS_RECIBOS_POR_TIPODONANTE_6');
                                                win.close();
                                            }   
                                        }
                                    ]
                    ...
                    Reportes.Rep_MYS_RECIBOS_POR_TIPODONANTE_6.superclass.initComponent.apply(this, arguments);
                    storeRep_MYS_RECIBOS_POR_TIPODONANTE_6.load();//en blanco comentar esta linea
                }
            });
        </script>
    </head>
