...
<html>
    <head>
        ...
        <script type="text/javascript"> 
            ...
            var storeRep_DB_ListadoDonantes_Activos = Ext.create('Ext.data.JsonStore', {// create the Store Atenciones
            ...
            //Inicia
            Ext.define('Reportes.Rep_DB_ListadoDonantes_Activos', {
                extend: 'Ext.window.Window',
                id:'Rep_DB_ListadoDonantes_Activos',
                name: 'Reportes.Rep_DB_ListadoDonantes_Activos',
                alias:'widget.Rep_DB_ListadoDonantes_Activos',                
                title: 'Reporte Listado de Donantes Activos',
                width: 1150,                
                height: 600,
                border: false,
                buttonAlign: 'left',
                ...
                initComponent: function() {
                    Ext.apply(this, {
                        items: [
                            {
                                xtype: 'grid',
                                store: storeRep_DB_ListadoDonantes_Activos,
                                id:'gridRep_DB_ListadoDonantes_Activos',
                                name:'gridRep_DB_ListadoDonantes_Activos',
                                columns: [
                                     {
                                    ...
                                    items: [
                                        {
                                            ...
                                            listeners: {
                                                select: function(field, value, option){
                                                    ...
                                                    storeRep_DB_ListadoDonantes_Activos.load();
                                                }
                                            }
                                        }
                                        ,
                                        ...
                                        ,Ext.create('Ext.Button', {
                                            ...
                                            iconCls:'icon-xlsx',
                                            handler: function() {
                                                window.open("ShowExcel?idOperationType=901&fechaini="+parametersAT.fechaini+ "&fechafin="+parametersAT.fechafin+"&usuario="+parametersAT.usuario);
                                            }
                                        }),
                                        {xtype:'tbseparator'},
                                        {
                    ...
                    Reportes.Rep_DB_ListadoDonantes_Activos.superclass.initComponent.apply(this, arguments);
                    storeRep_DB_ListadoDonantes_Activos.load();//en blanco comentar esta linea
                }
            });
        </script>
    </head>
