...
<html>
    <head>
        ...
        <script type="text/javascript"> 
            ...
            Ext.define('OPE_recibosDeducibles_3',{// create the Data Atenciones
                id:'OPE_recibosDeducibles_3',
                extend: 'Ext.data.Model',
                fields:     [
...
//                    {name: 'CAMPANA_FINANCIERA'},
            ...
            var storeOPE_recibosDeducibles = Ext.create('Ext.data.JsonStore', {// create the Store Atenciones
                model: 'OPE_recibosDeducibles_3',
                id: 'OPE_recibosDeducibles_3',
                name: 'OPE_recibosDeducibles_3',
                //                waitMsg:'Loading...',
                pageSize: 1000,
                //                autoLoad:false,
                proxy: {
...
//                }
            ...
            //Inicia
            Ext.define('Reportes.OPE_recibosDeducibles_3', {
                extend: 'Ext.window.Window',
                id:'OPE_recibosDeducibles_3',
                name: 'Reportes.OPE_recibosDeducibles_3',
                alias:'widget.OPE_recibosDeducibles_3',                
                title: 'Reporte de OPE Recibos Deducibles',
                width: 1300,                
                height: 600,
                border: false,
                buttonAlign: 'left',
                ...
                initComponent: function() {
                    ...
                    Ext.apply(this, {
                        items: [
                            {
                                xtype: 'grid',
                                store: storeOPE_recibosDeducibles,
...
//                                                    alert("check box 0");
                                                ...
                                                storeOPE_recibosDeducibles.proxy.extraParams.fechaini=fechaini;
                                                storeOPE_recibosDeducibles.proxy.extraParams.fechafin=fechafin;
                                                storeOPE_recibosDeducibles.proxy.extraParams.UsuarioAT=UsuarioAT;
                                                storeOPE_recibosDeducibles.proxy.extraParams.TipoListado=TipoListado;
                                                storeOPE_recibosDeducibles.proxy.extraParams.chekbox=chekbox;
                                                                                                alert("1-- " +fechaini);
                                                                                                alert("2-- " +fechafin);
                                                storeOPE_recibosDeducibles.load();
                                            }   
                                        ...
                                        {xtype:'tbseparator'},
                                        {
                                            ...
                                            handler: function()
                                            {
                                                var win=Ext.getCmp('OPE_recibosDeducibles_3');
                                                win.close();
                                            }   
                                        }
                                    ]
                    ...
                    Reportes.OPE_recibosDeducibles_3.superclass.initComponent.apply(this, arguments);
                    storeOPE_recibosDeducibles.load();//en blanco comentar esta linea
                }
            });
        </script>
    </head>
