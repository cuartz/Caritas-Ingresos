<%--
    Document   : Rep_MYS_RECIBOS_POR_EMPRESA_5
...
<html>
    <head>
        ...
        <script type="text/javascript"> 
            ...
            Ext.define('Rep_MYS_RECIBOS_POR_EMPRESA',{// create the Data Atenciones
                id:'Rep_MYS_RECIBOS_POR_EMPRESA',
            ...
            var storeRep_MYS_RECIBOS_POR_EMPRESA = Ext.create('Ext.data.JsonStore', {// create the Store Atenciones
                model: 'Rep_MYS_RECIBOS_POR_EMPRESA',
                waitMsg:'Loading...',
                pageSize: 1000,
                autoLoad:false,
                proxy: {
                    type: 'ajax',
                    url: 'reportesAC.do?method=report_Rep_MYS_RECIBOS_POR_EMPRESA', 
                    reader: {
                        type: 'json',
                        root: 'rows',
            ...
            //Inicia
            Ext.define('Reportes.Rep_MYS_RECIBOS_POR_EMPRESA_5', {
                extend: 'Ext.window.Window',
                id:'Rep_MYS_RECIBOS_POR_EMPRESA_5',
                name: 'Reportes.Rep_MYS_RECIBOS_POR_EMPRESA_5',
                alias:'widget.Rep_MYS_RECIBOS_POR_EMPRESA_5',                
                title: 'Listado de Recibos por Empresa',
                width: 1150,                
                height: 600,
                border: false,
                buttonAlign: 'left',
                ...
                initComponent: function() {
                    Ext.apply(this, {
                        items: [
                            {
                                xtype: 'grid',
                                store: storeRep_MYS_RECIBOS_POR_EMPRESA,
                                id:'gridRep_MYS_RECIBOS_POR_EMPRESA',
                                name:'gridRep_MYS_RECIBOS_POR_EMPRESA',
                                columns: [
                                    {
                                    ...
                                    items: [
                                        {
                                            ...
                                            listeners: {
                                                select: function(field, value, option){
                                                    ...
                                                    storeRep_MYS_RECIBOS_POR_EMPRESA.load();
                                                }
                                            }
                                        }
                                        ,
                                        ...
                                        ,Ext.create('Ext.Button', {
                                            ...
                                            iconCls:'icon-xlsx',
                                            handler: function() {
                                                window.open("ShowExcel?idOperationType=95&fechaini="+parametersAT.fechaini+ "&fechafin="+parametersAT.fechafin+"&usuario="+parametersAT.usuario);
                                            }
                                        }),
                                        {xtype:'tbseparator'},
                                        {
                                            ...
                                            handler: function()
                                            {
                                                var win=Ext.getCmp('Rep_MYS_RECIBOS_POR_EMPRESA_5');
                                                win.close();
                                            }   
                                        }
                                    ]
                    ...
                    Reportes.Rep_MYS_RECIBOS_POR_EMPRESA_5.superclass.initComponent.apply(this, arguments);
                    storeRep_MYS_RECIBOS_POR_EMPRESA.load();//en blanco comentar esta linea
                }
            });
        </script>
    </head>
