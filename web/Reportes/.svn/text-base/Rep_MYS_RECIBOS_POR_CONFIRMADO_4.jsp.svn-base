<%--
    Document   : Rep_MYS_RECIBOS_POR_CONFIRMADO_4
...
<html>
    <head>
        ...
        <script type="text/javascript"> 
            ...
            Ext.define('Rep_MYS_RECIBOS_POR_CONFIRMADO',{// create the Data Atenciones
                id:'Rep_MYS_RECIBOS_POR_CONFIRMADO',
            ...
            var storeRep_MYS_RECIBOS_POR_CONFIRMADO = Ext.create('Ext.data.JsonStore', {// create the Store Atenciones
                model: 'Rep_MYS_RECIBOS_POR_CONFIRMADO',
                waitMsg:'Loading...',
                pageSize: 1000,
                autoLoad:false,
                proxy: {
                    type: 'ajax',
                    url: 'reportesAC.do?method=report_Rep_MYS_RECIBOS_POR_CONFIRMADO', 
                    reader: {
                        type: 'json',
                        root: 'rows',
            ...
            //Inicia
            Ext.define('Reportes.Rep_MYS_RECIBOS_POR_CONFIRMADO_4', {
                extend: 'Ext.window.Window',
                id:'Rep_MYS_RECIBOS_POR_CONFIRMADO_4',
                name: 'Reportes.Rep_MYS_RECIBOS_POR_CONFIRMADO_4',
                alias:'widget.Rep_MYS_RECIBOS_POR_CONFIRMADO_4',                
                title: 'Listado de Recibos Confirmados',
                width: 1150,                
                height: 600,
                border: false,
                buttonAlign: 'left',
                ...
                initComponent: function() {
                    Ext.apply(this, {
                        items: [
                            {
                                xtype: 'grid',
                                store: storeRep_MYS_RECIBOS_POR_CONFIRMADO,
                                id:'gridRep_MYS_RECIBOS_POR_CONFIRMADO',
                                name: 'gridRep_MYS_RECIBOS_POR_CONFIRMADO',
                                columns: [
                                    {
                                    ...
                                    items: [
                                        {
                                            ...
                                            listeners: {
                                                select: function(field, value, option){
                                                    ...
                                                    storeRep_MYS_RECIBOS_POR_CONFIRMADO.load();
                                                }
                                            }
                                        }
                                        ,
                                        ...
                                        ,Ext.create('Ext.Button', {
                                            ...
                                            iconCls:'icon-xlsx',
                                            handler: function() {
                                                window.open("ShowExcel?idOperationType=94&fechaini="+parametersAT.fechaini+ "&fechafin="+parametersAT.fechafin+"&usuario="+parametersAT.usuario);
                                            }
                                        }),
                                        {xtype:'tbseparator'},
                                        {
                                            ...
                                            handler: function()
                                            {
                                                var win=Ext.getCmp('Rep_MYS_RECIBOS_POR_CONFIRMADO_4');
                                                win.close();
                                            }   
                                        }
                                    ]
                    ...
                    Reportes.Rep_MYS_RECIBOS_POR_CONFIRMADO_4.superclass.initComponent.apply(this, arguments);
                    storeRep_MYS_RECIBOS_POR_CONFIRMADO.load();//en blanco comentar esta linea
                }
            });
        </script>
    </head>
