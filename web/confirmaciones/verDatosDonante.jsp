...
<html>
    ...
    //Inicio
    Ext.define('confirmaciones.verDatosDonante', {
        extend: 'Ext.window.Window',                    
        alias:'widget.verDatosDonante',                    
        ...
        initComponent: function() {
                    ...
                    new Ext.Button({
                        ...
                        handler: function(){
                            ...
                            if(selectedRow != undefined){
                                if(sizeSelected == 1){                                             
                                    createNewObj2('donantes.bitacoraComentarios',selectedRow.data.ID_BITACORA); 
                                }else{
            ...
            confirmaciones.verDatosDonante.superclass.initComponent.apply(this, arguments); 
            storeBitacora.load();
