...
<html>
    <head>
        ...
        <script type="text/javascript"> 
            ...
            Ext.define('Rep_MYS_RECIBOS_COBRADOS',{// create the Data Atenciones
                id:'Rep_MYS_RECIBOS_COBRADOS',
            ...
            var storeRep_MYS_RECIBOS_COBRADOS = Ext.create('Ext.data.JsonStore', {// create the Store Atenciones
                model: 'Rep_MYS_RECIBOS_COBRADOS',
                waitMsg:'Loading...',
                pageSize: 1000,
                autoLoad:false,
                proxy: {
            ...
            //Inicia
            Ext.define('Reportes.Rep_MYS_RECIBOS_COBRADOS_2', {
                extend: 'Ext.window.Window',
                id:'Rep_MYS_RECIBOS_COBRADOS_2',
                name: 'Reportes.Rep_MYS_RECIBOS_COBRADOS_2',
                alias:'widget.Rep_MYS_RECIBOS_COBRADOS_2',                
                title: 'Listado de Recibos Cobrados',
                width: 1150,                
                height: 600,
                border: false,
                buttonAlign: 'left',
                ...
                initComponent: function() {
                                ...
                                tbar: {
                                    ...
                                    items: [
                                        ...
                                        ,Ext.create('Ext.Button', {
                                            ...
                                            iconCls:'icon-xlsx',
                                            handler: function() {
                                                window.open("ShowExcel?idOperationType=92&fechaini="+parametersAT.fechaini+ "&fechafin="+parametersAT.fechafin+"&usuario="+parametersAT.usuario);
                                            }
                                        }),
                                        {xtype:'tbseparator'},
                                        {
                                            ...
                                            handler: function()
                                            {
                                                var win=Ext.getCmp('Rep_MYS_RECIBOS_COBRADOS_2');
                                                win.close();
                                            }   
                                        }
                                    ]
                    ...
                    Reportes.Rep_MYS_RECIBOS_COBRADOS_2.superclass.initComponent.apply(this, arguments);
