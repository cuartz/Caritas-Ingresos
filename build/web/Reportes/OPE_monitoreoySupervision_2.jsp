...
//                    {name: 'CAMPANA_FINANCIERA'},
            ...
            var storeOPE_monitoreoySupervision = Ext.create('Ext.data.JsonStore', {// create the Store Atenciones
                model: 'OPE_CancelaciondeDonativos',
                id: 'storeOPE_monitoreoySupervision',
                name: 'storeOPE_monitoreoySupervision',
                //                waitMsg:'Loading...',
                pageSize: 200,
                //                autoLoad:false,
                proxy: {
...
//                }
            ...
            //Inicia
            Ext.define('Reportes.OPE_monitoreoySupervision_2', {
                extend: 'Ext.window.Window',
                id:'OPE_monitoreoySupervision_2',
                name: 'Reportes.OPE_monitoreoySupervision_2',
                alias:'widget.OPE_monitoreoySupervision_2',                
                title: 'Reporte de OPE Monitoreo y Supervision',
                width: 1200,                
                height: 600,
                border: false,
                buttonAlign: 'left',
                ...
                initComponent: function() {
                    ...
                    Ext.apply(this, {
                        items: [
                            {
                                xtype: 'grid',
                                store: storeOPE_monitoreoySupervision,
                                id:'gridOPE_monitoreoySupervision',
                                name: 'gridOPE_monitoreoySupervision',
                                columns: [
//                                    {
                                    ...
                                    items: [
                                        {
                                            ...
                                            //                                                    storeOPE_monitoreoySupervision.load();
                                            //                                                }
                                            //                                            }
                                        }
                                        ,
...
//                                                    alert("check box 0");
                                                ...
                                                storeOPE_monitoreoySupervision.proxy.extraParams.fechaini=fechaini;
                                                storeOPE_monitoreoySupervision.proxy.extraParams.fechafin=fechafin;
                                                storeOPE_monitoreoySupervision.proxy.extraParams.UsuarioAT=UsuarioAT;
                                                storeOPE_monitoreoySupervision.proxy.extraParams.TipoListado=TipoListado;
                                                storeOPE_monitoreoySupervision.proxy.extraParams.chekbox=chekbox;
                                                                                                alert("1-- " +fechaini);
                                                                                                alert("2-- " +fechafin);
                                                storeOPE_monitoreoySupervision.load();
                                            }   
                                        ...
                                        {xtype:'tbseparator'},
                                        {
                                            ...
                                            handler: function()
                                            {
                                                var win=Ext.getCmp('OPE_monitoreoySupervision_1');
                                                win.close();
                                            }   
                                        }
                                    ]
                    ...
                    Reportes.OPE_monitoreoySupervision_2.superclass.initComponent.apply(this, arguments);
                    storeOPE_monitoreoySupervision.load();//en blanco comentar esta linea
                }
            });
        </script>
    </head>
