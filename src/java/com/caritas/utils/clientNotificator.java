 ...
 * @author RCastilloc
 */
public class clientNotificator extends JFrame {
   ...
   public clientNotificator( String host )
   {
      super( "Cliente" );
   ...
   public static void main( String args[] )
   {
      ...
      clientNotificator aplicacion;

      if ( args.length == 0 )
         aplicacion = new clientNotificator( "127.0.0.1" );
      else
         aplicacion = new clientNotificator( args[ 0 ] );
